...
OUTPUT = REPO_ROOT / "docs" / "release" / "backend_runtime_wiring_cases_report.md"
...
COMMANDS = [
    ...
    ("implementation 376-382", [sys.executable, "scripts/generate_backend_runtime_wiring_preflight_report.py"]),
]
...
def main() -> int:
    ...
    lines.extend(["", "## Boundary", "", "This report proves fixture-backed runtime wiring readiness only.", ""])
