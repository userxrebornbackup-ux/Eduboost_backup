...
REQUIRED_EVIDENCE = ['app/frontend/package.json', 'app/frontend/src', 'app/frontend/src/lib', 'app/frontend/src/app', 'docs/frontend', 'scripts/check_frontend_journey_evidence.py', 'scripts/check_frontend_accessibility_contract.py', '.github/workflows/cluster-g-frontend.yml', 'Makefile']
