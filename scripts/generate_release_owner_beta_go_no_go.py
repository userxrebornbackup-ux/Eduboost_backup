...
def main() -> int:
    ...
    lines = [
        ...
        f"## Recommendation: {decision}", "", "## Basis", "",
        f"Beta readiness status: `{status}`", "", "## Blockers", "",
    ]
    ...
    lines.extend([
        ...
        "## Release-owner decision", "", "- [ ] Approved for controlled beta", "- [ ] Conditional approval", "- [ ] Rejected", "", "Release owner:", "", "Date:", "",
    ])
