...
OUTPUT = REPO_ROOT / "docs" / "release" / "backend_consolidation_execution_report.md"
...
COMMANDS = [
    ...
    ("release guard", [sys.executable, "scripts/check_backend_consolidation_release_guard.py"]),
