...
import { BetaLabel } from "../components/eduboost/BetaAndFeedback";
  ...
  return (
    <main id="main-content" className="min-h-screen bg-[var(--bg)] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-6 text-center">
        <div className="mb-4 flex justify-center"><BetaLabel /></div>
        ...
        <p className="text-[var(--muted)] font-medium mb-12">
          AI-powered learning for South African learners Grade R to Grade 7. Beta scope is deliberately limited and reviewed.
        </p>
