...
import { BetaLabel, FeedbackButton } from "./BetaAndFeedback";
    ...
    <>
      <aside className="sidebar" aria-label="Learner navigation">
        <div style={{ padding: "0 20px 24px", borderBottom: "1px solid var(--border)", marginBottom: 8 }}>
          <div className="flex flex-col gap-2"><strong>EduBoost SA</strong><BetaLabel /></div>
        </div>
        ...
        <div style={{ marginTop: "auto", padding: 16 }}>
          <div className="flex flex-col gap-2"><FeedbackButton context="learner-dashboard" /><button className="btn-secondary" onClick={onLogout} style={{ width: "100%" }}>Logout</button></div>
        </div>
      </aside>
